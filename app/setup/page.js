...
export default function SetupPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-blue-50 dark:bg-[#09090b]">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50 dark:bg-[#09090b] px-4 py-12">
