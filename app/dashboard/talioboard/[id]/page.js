...
export default function WhiteboardEditorPage() {
  ...
  return (
    <div ref={containerRef} className="h-screen flex flex-col bg-gray-50">
      {/* Saving overlay */}
      {isSaving && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: 'rgba(255,255,255,0.6)' }}>
      ...
      {/* Rename Modal */}
      {showRenameModal && (
        <div className="fixed inset-0 z-[9200] flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(255,255,255,0.6)' }}>
