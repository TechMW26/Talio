...
import { FaTimes, FaPaperPlane, FaTrash, FaExternalLinkAlt, FaHistory, FaPlus, FaChevronLeft, FaRegTrashAlt } from 'react-icons/fa'
  ...
  return (
    <div className="flex items-start gap-3 px-4 py-3">
      ...
      <div className="flex-1">
        <p className="text-xs font-medium text-primary-500 mb-2">MIRA is thinking...</p>
    ...
    <>
      ...
      >
        ...
        >
          <div className="flex items-end gap-2">
            <div className="flex-1 relative">
              <textarea
                ...
                placeholder={isThinking ? 'MIRA is thinking...' : 'Ask MIRA anything...'}
                disabled={isThinking}
                rows={1}
          ...
          <p className="text-[10px] text-default-400 text-center mt-2">
            <span className="font-medium">{tokens.tokensRemaining}/{tokens.tokenLimit}</span> Mira tokens remaining this month
          </p>
        </div>
        )}
      </div>
