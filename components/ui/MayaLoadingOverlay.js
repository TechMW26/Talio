...
/**
 * Maya AI Loading Overlay
 * A beautiful animated blob loading indicator for AI operations
 * Based on /public/maya/blob.html design
 */
export default function MayaLoadingOverlay({
  isLoading,
  ...
  return (
    <div className={overlayClasses}>
      {/* Animated Maya Blob */}
      <div
        className="relative maya-blob-speaking"
        style={{
      ...
      <style jsx>{`
        .maya-blob-speaking {
          animation: mayaPulse 0.6s ease-in-out infinite;
        }
