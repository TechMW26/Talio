...
async function loadGridFSScreenshotById(gridfsId) {
...
export async function loadScreenshotForAnalysis(screenshot, options = {}) {
    ...
    if (directGridfsId) {
        return loadGridFSScreenshotById(directGridfsId);
    }
    ...
    if (activityScreenshotId) {
        ...
        if (screenshotRecord.gridfsFileId) {
            return loadGridFSScreenshotById(screenshotRecord.gridfsFileId);
        }
