...
function scheduleApiRevalidation(mutateFunction = mutate) {
...
export function revalidateAllApiQueries(mutateFunction = mutate) {
  scheduleApiRevalidation(mutateFunction)
}
