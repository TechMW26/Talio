...
export async function sendMeetingInviteEmail({
  ...
  const htmlParts = [
    `<div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; padding: 32px; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">`,
...
export async function sendMeetingReminderEmail({
  ...
  const htmlParts = [
    ...
    `<p style="color: #1e293b; margin: 12px 0;"><strong>Type:</strong> ${typeLabel}</p>`,
  ]

  if (location) {
    htmlParts.push(`<p style="color: #1e293b; margin: 12px 0;"><strong>Location:</strong> ${location}</p>`)
  }

  if (meetingLink && meetingType === 'online') {
    htmlParts.push(
      `<div style="margin: 24px 0;">`,
      `<a href="${meetingLink}" style="display: inline-block; padding: 14px 28px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; text-decoration: none; border-radius: 10px; font-weight: 600; box-shadow: 0 4px 14px -3px rgba(59, 130, 246, 0.4);">Join Meeting Now</a>`,
      `</div>`
    )
  }
...
export async function sendMeetingCancellationEmail({
  ...
  const htmlParts = [
    ...
    `<p style="color: #1e293b; font-size: 16px; margin-bottom: 20px;">Hi${greetingName},</p>`,
    ...
    `<p style="margin: 0 0 10px 0; color: #1e293b;"><strong>📋 Meeting:</strong> ${meetingTitle}</p>`,
  ...
  htmlParts.push(
    `</div>`,
    `<p style="color: #64748b; font-size: 14px; margin-top: 25px;">If you have any questions, please contact the organizer directly.</p>`,
    `</div>`,
...
export async function sendMeetingMOMEmail({
  ...
  const htmlParts = [
    ...
    `<h4 style="margin: 0 0 15px 0; color: #3b82f6; font-size: 16px;">📋 Meeting Minutes</h4>`,
  ...
  if (aiSummary) {
    htmlParts.push(
      ...
      `<h4 style="margin: 0 0 15px 0; color: #0ea5e9; font-size: 16px;">🤖 AI Summary</h4>`,
  ...
  if (meetingLink) {
    htmlParts.push(
      ...
      `<a href="${meetingLink}" style="display: inline-block; padding: 14px 28px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px;">View Meeting Details</a>`,
      `</div>`
    )
  }
    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse;">
          ...
          <tr>
            <td>
              <table role="presentation" style="width: 100%; border-collapse: collapse; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1);">
                ...
                <tr>
                  <td style="padding: 0 40px 30px 40px;">
                    <table role="presentation" style="width: 100%; border-collapse: collapse; background: #f0fdf4; border-radius: 16px; border: 1px solid #bbf7d0;">
                      <tr>
                        <td style="padding: 24px;">
                          <table role="presentation" style="width: 100%; border-collapse: collapse;">
                            <tr>
                            ...
                            <tr>
                              <td style="padding: 8px 0;">
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                  ...
                                  <tr>
                                    <td style="background: #ffffff; padding: 12px 16px; border-radius: 8px; font-family: 'Monaco', 'Consolas', monospace; font-size: 14px; color: #1e293b; letter-spacing: 0.3px; border: 1px solid #e2e8f0;">
                                      ${email}
                                    </td>
                                  </tr>
                                </table>
                            ...
                            <tr>
                              <td style="padding: 12px 0 0 0;">
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                  ...
                                  <tr>
                                    <td style="background: #ffffff; padding: 12px 16px; border-radius: 8px; font-family: 'Monaco', 'Consolas', monospace; font-size: 14px; color: #d97706; letter-spacing: 0.5px; border: 1px solid #e2e8f0;">
                                      ${password}
                                    </td>
                                  </tr>
                                </table>
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="padding-bottom: 12px;">
                          <a href="https://app.talio.in/resources" style="display: block; text-align: center; padding: 16px 32px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 50%, #1d4ed8 100%); color: #ffffff; text-decoration: none; border-radius: 12px; font-size: 15px; font-weight: 600; box-shadow: 0 4px 14px -3px rgba(59, 130, 246, 0.4);">
                      ...
                      <tr>
                        <td>
                          <a href="https://app.talio.in/login" style="display: block; text-align: center; padding: 14px 32px; background: #f8fafc; border: 1px solid #e2e8f0; color: #3b82f6; text-decoration: none; border-radius: 12px; font-size: 14px; font-weight: 600;">
                            🌐 Login via Browser
                          </a>
                        </td>
                      </tr>
          ...
          <tr>
            <td>
              <table role="presentation" style="width: 100%; border-collapse: collapse; background: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1);">
                ...
                <tr>
                  <td style="padding: 0 40px 30px 40px;">
                    <table role="presentation" style="width: 100%; border-collapse: collapse; background: #fef3c7; border-radius: 16px; border: 1px solid #fde68a;">
                      <tr>
                ...
                <tr>
                  <td style="padding: 0 40px 30px 40px; text-align: center;">
                    <a href="${resetLink}" style="display: inline-block; padding: 16px 48px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 50%, #1d4ed8 100%); color: #ffffff; text-decoration: none; border-radius: 12px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 14px -3px rgba(59, 130, 246, 0.4);">
                      Reset Password
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 0 40px 30px 40px;">
                    ...
                    <p style="margin: 0; font-size: 12px; color: #3b82f6; word-break: break-all; text-align: center; background: #f8fafc; padding: 12px; border-radius: 8px; border: 1px solid #e2e8f0;">
                      ${resetLink}
                    </p>
                  </td>
                </tr>
