...
const EmployeeSchema = new mongoose.Schema({
  ...
  lifecycle: {
    ...
    onboarding: {
      ...
      targetDate: Date,
      completedAt: Date,
      checklist: [{ key: String, label: String, required: { type: Boolean, default: true }, completed: { type: Boolean, default: false }, completedAt: Date, completedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null }, completionSource: { type: String, enum: ['manual', 'system'], default: null } }],
    },
    probation: {
...
const AttendanceSchema = new mongoose.Schema({
  ...
  source: { type: String, enum: ['manual', 'geofence', 'system', 'correction', 'import', 'auto_checkout', 'attendance_machine'], default: 'manual' },
