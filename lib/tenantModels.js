...
/**
 * ForceRefresh Schema
 * Stores pending force-refresh commands for users when Socket.IO is unavailable (e.g. Vercel).
...
/**
 * UserPresence Schema — DB-backed heartbeat for presence tracking (Vercel fallback)
