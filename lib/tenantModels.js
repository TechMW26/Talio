...
const EmployeeSchema = new mongoose.Schema({
  ...
  lifecycle: {
    ...
    onboarding: {
      ...
      targetDate: Date,
      completedAt: Date,
      checklist: [{ key: String, label: String, required: { type: Boolean, default: true }, completed: { type: Boolean, default: false }, completedAt: Date, completedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null } }],
    },
    probation: {
