...
export async function sendNotificationToMultipleDevices(tokens, notification, data = {}) {
    try {
        ...
        // Prefer sendEachForMulticast (firebase-admin >= 11.7); fall back to
        // sendMulticast for older installs (e.g. v10). Both return the same
        // BatchResponse shape ({ successCount, failureCount, responses }).
        const sendFn = typeof messaging.sendEachForMulticast === 'function'
