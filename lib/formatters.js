...
export const formatDesignation = (designation, employee = null) => {
  ...
  let title = designation.title || designation.name || ''
  
  // If title is still an object, try to extract string from it
 ...
 * Convention: L9 = Director (top), L8 = Asst Director, L7 = C-Suite, L6 = Manager,
 * L5 = Asst Manager, L4 = Team Lead, L3 = Senior, L2 = Mid, L1 = Entry.
 * Legacy 1-7 numbering is mapped via the migration script.
 * @param {number} level - Level number (1-9)
