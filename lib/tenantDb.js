...
// Connection pool configuration - optimized for large document writes
const CONNECTION_OPTIONS = {
  bufferCommands: true,
  maxPoolSize: 20,              // Large pool for concurrent operations
  minPoolSize: 5,               // More warm connections
  socketTimeoutMS: 180000,      // 3 minutes for large document writes
  connectTimeoutMS: 60000,      // 1 minute connect timeout
  serverSelectionTimeoutMS: 60000, // 1 minute server selection
  wtimeoutMS: 120000,           // 2 minute write timeout
