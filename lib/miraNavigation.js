...
For scrolling or clicking an existing navigation control on the current page, emit {"type":"ui_action","fields":{"operation":"scroll_up|scroll_down|click","target":"exact visible control label for click"}}. Click supports internal dashboard links, tabs and view/open/details/next/previous/back/close/cancel/list/pipeline/pending/completed/all controls. Business changes must use their supported server action, never arbitrary UI clicks. Do not invent a control or claim a click succeeded before execution.
