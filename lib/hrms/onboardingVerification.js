export const ONBOARDING_VERIFICATION_REQUIREMENTS = Object.freeze({
  ...
  documents: {
    ...
    description: 'Upload each mandatory identity, education, and police-verification document. Every file is also added to the employee document register.',
    fields: [],
    uploads: [
      { key: 'aadhaar', label: 'Aadhaar card', required: true },
      { key: 'pan', label: 'PAN card', required: true },
      { key: 'class_10_marksheet', label: 'Class 10 marksheet', required: true },
      { key: 'class_12_marksheet', label: 'Class 12 marksheet', required: true },
      { key: 'graduation', label: 'Graduation marksheet or certificate', required: true },
      { key: 'police_verification', label: 'Police verification', required: true },
    ],
  },
