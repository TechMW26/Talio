 ...
 */
export async function respondToCompletionApproval(approvalId, responderEmployee, approve, remark = '', unmarkSubtasks = false, models) {
  const { Project, ProjectCompletionApproval, Task, ProjectTimelineEvent } = models
