...
async function generateAIMessage(occasion, employeeName, context = {}) {
  try {
    ...
    // Use centralized AI service from gemini.js for consistent fallback handling
    ...
    const aiMessage = await generateContent(prompts[occasion] || prompts.officeStart, systemInstruction)
