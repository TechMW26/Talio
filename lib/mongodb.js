...
// This helps avoid querySrv ETIMEOUT errors with MongoDB Atlas
...
async function connectDB() {
  ...
  try {
    const opts = {
      ...
      maxPoolSize: isProduction ? 50 : 20, // Higher pool for production
      minPoolSize: isProduction ? 10 : 5, // Keep more connections warm in production
      socketTimeoutMS: isProduction ? 90000 : 60000, // Longer timeout for production
      connectTimeoutMS: isProduction ? 30000 : 20000, // More forgiving in production
      serverSelectionTimeoutMS: isProduction ? 30000 : 20000, // More forgiving in production
      heartbeatFrequencyMS: isProduction ? 20000 : 10000,
      family: 4, // Force IPv4 to avoid querySrv ETIMEOUT errors
      retryWrites: true,
      retryReads: true,
      maxIdleTimeMS: isProduction ? 120000 : 60000, // 2 minutes in production
      // Authentication retry configuration
      authSource: 'admin',
      // Compression - use only zlib which is always available
      compressors: ['zlib'],
