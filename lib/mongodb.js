...
async function connectDB() {
  ...
  const poolConfig = getMongoPoolConfig('primary');
  ...
  try {
    ...
    // Add connection event listeners ONCE per process. Re-adding them on every
    // reconnect accumulates closures on the singleton mongoose.connection and
    // eventually leaks memory (heap OOM).
